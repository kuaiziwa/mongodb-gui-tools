        ...
        [    
            {
                ...
                rows: [
                    ["Release", tp.ver("2022.8.3","2022-10-07"),tp.ver("7.1.13","2022-10-16"), tp.ver("1.33.1","2022-09-14"),tp.ver("16.1.2","2022-09-28"),tp.ver("7.0.3","2022-07-05")],
...
- User-defined code snippets`}, true, true, false, true, false],
                    ...
                    // ["Query script history", true, true],
                    // ["Syntax highlighting", true, true],
                    // ["Automatic indent and Code formatter", false, true],
                    // ["Code folding", false, true],
                    //["Parameter Hints", true, true],
                    //["Bracket and parentheses matching", true, true],
                    //["Mark changed lines", false, true],
...
// `Fine code-level control of the import and export process for complex data conversion.`}, false, true, false, false, false],
            ...
            },
            {
                ...
                rows: [
                    ...
                    [{name:"Cloud collaboration", title:"Store your files in cloud to start collaboration with your team members."}, false, false, false, {title:"[Click here to view](https://www.navicat.com/en/products#navicat-collaboration) Navicat's collaboration features.", interactive:true}, false],
